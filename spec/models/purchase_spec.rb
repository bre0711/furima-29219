  ...
  describe '商品の購入' do
    ...
    context '購入がうまくいかないとき' do
      ...
      it '郵便番号が空では購入できない' do
        ...
        @purchase.valid?
        expect(@purchase.errors.full_messages).to include("郵便番号はハイフン有りの7桁の数字でで入力してください", "郵便番号を入力してください")
      end
      ...
      it '電話番号が空では購入できない' do
        ...
        @purchase.valid?
        expect(@purchase.errors.full_messages).to include("電話番号はハイフン無しの11桁以内で入力してください", "電話番号を入力してください")
      end
      it '郵便番号にハイフンがないと購入できない' do
        @purchase.postal_number = '4844433'
        @purchase.valid?
        expect(@purchase.errors.full_messages).to include("郵便番号はハイフン有りの7桁の数字でで入力してください")
      end
      it '電話番号にハイフンがあると購入できない' do
        @purchase.phone_number = '0120-44-3322'
        @purchase.valid?
        expect(@purchase.errors.full_messages).to include("電話番号はハイフン無しの11桁以内で入力してください")
      end
    end
  end
end
